...
happyReduction_1 ((HappyAbsSyn4  happy_var_4) `HappyStk`
	_ `HappyStk`
	(HappyTerminal (TokenVariable happy_var_2)) `HappyStk`
	_ `HappyStk`
	happyRest)
	 = HappyAbsSyn4
...
happyReduction_4 (HappyTerminal (TokenVariable happy_var_1))
	 =  HappyAbsSyn4
		 (TyVar happy_var_1
	)
...
happyReduction_5 (HappyTerminal (TokenLabel happy_var_3))
	_
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenCaret -> cont 9;
	TokenArrow -> cont 10;
	TokenVariable happy_dollar_dollar -> cont 11;
	TokenLabel happy_dollar_dollar -> cont 12;
	_ -> happyError' (tk:tks)
	}
...
stype tks = happyRunIdentity happySomeParser where
